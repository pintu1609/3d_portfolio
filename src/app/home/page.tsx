...
export default function Home() {
    return (
        ...
        <div className="flex justify-center items-center gap-[5rem] h-full w-4/5 mx-auto h-full ">
            <div className="flex flex-col justify-start gap-2 ">
                ...
                <div className="flex space-x-8 mt-4 items-center">
                    ...
                    <Link href="https://github.com/pintu1609" passHref className="group flex items-center justify-center relative border border-main-color p-2 rounded-full h-[max-content] hover:bg-main-color">
                    ...
                    Github
                        ...
                        <Link href="https://www.linkedin.com/in/pintu-kumar-46b147204/" passHref className="group flex items-center justify-center relative border border-main-color p-2 rounded-full h-[max-content] hover:bg-main-color">
                        <i className='bx bxl-linkedin text-2xl text-main-color group-hover:text-bg-color'></i>
                        <span className="tooltips absolute top-[-2rem] left-[50%] transform -translate-x-1/2 rounded-md bg-main-color opacity-0 text-bg-color text-sm whitespace-nowrap py-[4px] px-[4px]">
                        Linkedin
                            </span>
                        </Link>
                        <Link href="https://x.com/Pintu_Kumar_24" passHref className="group flex items-center justify-center relative border border-main-color p-2 rounded-full h-[max-content] hover:bg-main-color">
                        <i className='bx bxl-twitter text-2xl text-main-color group-hover:text-bg-color'></i>
                        <span className="tooltips absolute top-[-2rem] left-[50%] transform -translate-x-1/2 rounded-md bg-main-color opacity-0 text-bg-color text-sm whitespace-nowrap py-[4px] px-[4px]">
                        Twitter
                            </span>
                        </Link>
                        <Link href="https://www.instagram.com/pintu_kumar_29/" passHref className="group flex items-center justify-center relative border border-main-color p-2 rounded-full h-[max-content] hover:bg-main-color">
                        <i className='bx bxl-instagram text-2xl text-main-color group-hover:text-bg-color'></i>
                        <span className="tooltips absolute top-[-2rem] left-[50%] transform -translate-x-1/2 rounded-md bg-main-color opacity-0 text-bg-color text-sm whitespace-nowrap py-[4px] px-[4px]">
                        Instagram
                            </span>
                        </Link>
                        <Link href="mailto:pintukumar160900@gmail.com" passHref className="group flex items-center justify-center relative border border-main-color p-2 rounded-full h-[max-content] hover:bg-main-color">
