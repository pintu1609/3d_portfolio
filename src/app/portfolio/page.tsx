...
export default function Portfolio() {
    ...
    return (
        <div className="bg-gradient-to-br from-[#020617] via-[#0f172a] to-[#020617] h-screen w-full overflow-y-auto">
        ...
        <div className="flex flex-col justify-start gap-4 w-full">
            ...
            <div className="flex w-full h-[.2rem]">
             ...
             <div className="overflow-y-auto scrollbar scrollbar-thumb-main-color scrollbar-track-transparent " style={{height:`calc(100vh - 16rem)`}}>
